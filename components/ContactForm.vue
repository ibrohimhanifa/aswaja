<template>
  <div>
    ...
    >
      ...
      <div class="">
        <button
          class="w-full shadow bg-green-400 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
          type="submit"
        >
          Send
        </button>
...
// const textarea = document.querySelector('textarea.autoexpand')
